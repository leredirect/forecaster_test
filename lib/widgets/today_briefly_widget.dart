    ...
    return BlocBuilder<CurrentWeatherDataBloc, CurrentWeather>(
      ...
      if (state.weather.isNotEmpty) {
        return Column(
          ...
          children: [
            Icon(
              Utils.nameToIconMap[state.weather.first.icon],
            ...
            Row(
              ...
              children: [
                ...
                Container(
                    ...
                    child: Text(
                      state.name + ", " + state.currentSys.country,
                      style: bigText,
                    )),
                Spacer(),
              ],
            ...
            Text(
              state.main.temp.round().toString() +
                  "C°" +
                  " | " +
                  state.weather.first.description.toString().toUpperCase(),
              style: blueBigText,
            ),
          ],
        );
